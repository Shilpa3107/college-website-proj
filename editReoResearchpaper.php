							...
							<div class="col-xs-12">
                                ...
                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" name="author_name" value="<?php echo $row['Author']; ?>" placeholder="Enter Author's Name" class="input-sm" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="clearfix">
												<input type="text" id="form-field-5" name="Co-author" value="<?php echo $row['Co-author']; ?>" placeholder="Enter Corresponding/Co-author's Name" class="col-xs-1" />
											</div>
											<div class="space-2"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="papertitle" value="<?php echo $row['papertitle']; ?>" placeholder="Enter Title of Paper" class="input-sm" />
											<div class="space-2"></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="journal_name" value="<?php echo $row['journalname']; ?>" placeholder="Enter Name of Journal" class="input-sm" />
											<div class="space-2"></div>
										</div>
									</div>
